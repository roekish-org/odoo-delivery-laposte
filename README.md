...
<p align="center">
  ...
  Tarification &middot; étiquettes &middot; suivi &middot; points de retrait.
</p>
...
| 🏷️ **Étiquettes** | Génération d'étiquette Colissimo via [`roulier`](https://pypi.org/project/roulier/) ; numéro de suivi enregistré sur le bon de livraison. |
...
- Droits d'accès fins : groupes **Utilisateur** / **Administrateur** dédiés.
